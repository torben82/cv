...
%  \end{itemize}
\item[2016 April$\rightarrow$ 2016 November] Employed as consultant at Danish Technological Institute (DTI), Center for Refrigeration and Heat Pump Technology. %Assignments include:
  %\begin{itemize}
